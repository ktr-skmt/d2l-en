...
$$\hat{y} = \mathbf{w}^T \mathbf{x} + b.$$ :eqlabel:`eq_linear_regression_single`
...
$${\hat{\mathbf{y}}} = \mathbf X \mathbf{w} + b.$$ :eqlabel:`eq_linear_regression`
...
![Linear regression is a single-layer neural network. ](../img/singleneuron.svg) :label:`fig_single_neuron`
